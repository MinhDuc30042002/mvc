...
<div class="m-auto mt-10 flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:w-3/4 hover:bg-gray-100">
    <img class="object-cover w-full h-96 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src="<?= $data['post']['image'] ?>" alt="">
...
<form class="w-3/4 m-auto mt-8" action="index.php?controller=posts&action=store&id=<?= $data['post']['id'] ?>" method="post">
