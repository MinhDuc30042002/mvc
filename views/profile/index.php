        ...
        <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <form action="index.php?controller=profile&action=edit" method="post">
                    ...
                    <p class="mt-2 text-pink-600 text-sm" id="error_name">
                        <?= $data['edit_user']['errors']['name'] ?? '' ?>
                    </p>
                    ...
                    <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"><svg class="h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <input onkeyup="onKeyUpEmail()" id="email" class="w-full" type="text" name="email" value="<?= $_POST['email'] ?? $data['user']->email  ?>">
                    <p class="mt-2 text-pink-600 text-sm" id="error_email">
                        <?= $data['edit_user']['errors']['email'] ?? '' ?>
                    </p>
                    ...
                    <p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start"><svg class="h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        </svg> <input onkeyup="onKeyUpPassword()" id="pass" class="w-full" type="password" name="pass" value="<?= $data['user']->password ?>"></p>
                    <p class="mt-2 text-pink-600 text-sm" id="error_pass">
                        <?= $data['edit_user']['errors']['pass'] ?? '' ?>
                    </p>

                    <p class="pt-8 text-sm">Giới thiệu đôi nét về bản thân</p>
                    <p class="mt-2 text-green-600 text-sm">
                        <?= $_SESSION['success'] ?? '' ?>
                    </p>
                    <?php unset($_SESSION['success']) ?>
                    <div class="pt-12 pb-8">
                        <button id="update" name="update" class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
                            Cập nhật
                        </button>
                    </div>
                </form>
